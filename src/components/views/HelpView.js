            ...
            <div class="help-container">
                <div class="option-group">
                    ...
                    <div class="community-links">
                        <div class="community-link" @click=${() => this.handleExternalLinkClick('https://Assistant.com')}>
                            🌐 Official Website
                        </div>
                        <div class="community-link" @click=${() => this.handleExternalLinkClick('https://github.com/sohzm/jarvis')}>
                            📂 GitHub Repository
                        </div>
                ...
                <div class="option-group">
                    ...
                    <div class="keyboard-section">
                        ...
                        <div class="keyboard-group">
                            ...
                            <div class="shortcut-item">
                                <span class="shortcut-description">Cycle layout modes</span>
                                <div class="shortcut-keys"><span class="key">Shift</span><span class="key">Alt</span><span class="key">L</span></div>
                            </div>
                            <div class="shortcut-item">
                                <span class="shortcut-description">Toggle focus mode</span>
                                <div class="shortcut-keys"><span class="key">Shift</span><span class="key">Alt</span><span class="key">F</span></div>
                            </div>
                        </div>
                        ...
                        <div class="keyboard-group">
                            ...
                            <div class="shortcut-item">
                                <span class="shortcut-description">Toggle microphone</span>
                                <div class="shortcut-keys">${this.formatKeybind(this.keybinds.microphoneToggle)}</div>
                            </div>
                            <div class="shortcut-item">
                                <span class="shortcut-description">Reinitialize session</span>
                                <div class="shortcut-keys">${this.formatKeybind(this.keybinds.reinitializeSession)}</div>
                            </div>
                            <div class="shortcut-item">
                        ...
                        <div class="keyboard-group">
                            ...
                            <div class="shortcut-item">
                                <span class="shortcut-description">Toggle auto-scroll</span>
                                <div class="shortcut-keys">${this.formatKeybind(this.keybinds.toggleAutoScroll)}</div>
                            </div>
                        </div>
